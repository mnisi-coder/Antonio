            ...
            ?>
                ...
                <form method="POST" action="profileUpdate">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12"><label class="labels">Education</label><input type="text" class="form-control" name="hold" placeholder="education" value="<?php echo $user['email'] ?>"></div>
                    </div>
